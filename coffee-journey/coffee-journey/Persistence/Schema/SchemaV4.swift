...
//  coffee-journey
//
//  Created by Julian Schenkemeyer on 17.06.26.
//
...
/// Version 4 of the Coffee Journey schema.
///
/// Changes from V3:
/// - `Brew` now tracks the clarity of the shot
enum SchemaV4: VersionedSchema {
    static var versionIdentifier: Schema.Version { .init(4, 0, 0) }

    static var models: [any PersistentModel.Type] {
        [
            SchemaV4.Coffee.self,
            SchemaV4.Recipe.self,
            SchemaV4.Equipment.self,
            SchemaV4.Brew.self,
            SchemaV4.Refill.self,
            SchemaV4.MaintenanceTemplate.self,
            SchemaV4.MaintenanceTemplateStep.self,
            SchemaV4.MaintenanceInstance.self,
        ]
    }
    ...
    @Model final class Brew {
        ...
        init(date: Date, beanAge: Int?, amountCoffee: Double, grindSetting: Double, temperature: Int, extractionTime: Int, taste: Int, output: Double, rating: BrewRating, clarity: Int? = nil) {
            self.date = date
            self.beanAge = beanAge
