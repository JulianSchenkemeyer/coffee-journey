...
//  coffee-journey
//
//  Created by Julian Schenkemeyer on 15.04.26.
//
...
/// Version 3 of the Coffee Journey schema.
///
/// Changes from V2:
/// - `Brew` now tracks the age of the beans
enum SchemaV3: VersionedSchema {
    static var versionIdentifier: Schema.Version { .init(3, 0, 0) }

    static var models: [any PersistentModel.Type] {
        [
            SchemaV3.Coffee.self,
            SchemaV3.Recipe.self,
            SchemaV3.Equipment.self,
            SchemaV3.Brew.self,
            SchemaV3.Refill.self,
            SchemaV3.MaintenanceTemplate.self,
            SchemaV3.MaintenanceTemplateStep.self,
            SchemaV3.MaintenanceInstance.self,
        ]
    }
    ...
    @Model final class Brew {
        ...
        init(date: Date, beanAge: Int?, amountCoffee: Double, grindSetting: Double, temperature: Int, extractionTime: Int, taste: Int, output: Double, rating: BrewRating) {
            self.date = date
