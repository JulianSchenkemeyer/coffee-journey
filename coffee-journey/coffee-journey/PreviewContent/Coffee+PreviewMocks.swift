...
extension Coffee {
    struct Mock {
        static let espresso = Coffee(
            ...
            brews: [],
            recipes: [.init(name: "Default", temperature: 94, grindsize: 10, extractionTime: 33, input: 18.4, output: 37.3),
                      .init(name: "Turbo", temperature: 94, grindsize: 14, extractionTime: 20, input: 18.3, output: 36.5)],
            totalBrews: 5,
            brewsSinceRefill: 1,
